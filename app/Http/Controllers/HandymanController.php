...
class HandymanController extends Controller
{
    ...
    private function compressProfileImageForUpload($file): ?array
    {
        ...
        try {
            ...
            $safeName = preg_replace('/[^a-zA-Z0-9_-]/', '', $baseName) ?: 'handyman-profile';
            $fileName = $safeName . '.jpg';
            $tempPath = tempnam(sys_get_temp_dir(), 'handyman_profile_');
            ...
            \Log::warning('Handyman profile image compression failed: ' . $e->getMessage());
            return null;
        } finally {
            if ($sourceImage) {
