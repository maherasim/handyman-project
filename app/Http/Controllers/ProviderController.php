...
public function store(UserRequest $request)
{
    ...
    public function createStripePayment(Request $request)
    {
        ...
        $currencyCode = $country ? $country->currency_code : 'EUR';
                ...
                'line_items' => [[
                    'price_data' => [
                        ...
                        'product_data' => [
                            ...
                            'description' => $newPlan->description ?? 'Subscription plan upgrade',
                        ],
                        'unit_amount' => stripe_unit_amount_from_decimal($request->plan_amount, $currencyCode),
                    ],
                    'quantity' => 1,
                ]],
                'mode' => 'payment',
