...
class BookingResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'total_rating'          => (float) number_format(max(optional($this->service)->serviceRatingPublic->avg('rating'), 0), 2),
            'amount'                => $this->amount,
            ...
            'total_review'          => optional($this->service)->serviceRatingPublic->count(),
