...
class BookingDetailResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'booking_date' => $this->date ? Carbon::parse($this->date)->toISOString() : null,
            'start_at'     => $this->start_at ? Carbon::parse($this->start_at)->toISOString() : null,
            'end_at'       => $this->end_at ? Carbon::parse($this->end_at)->toISOString() : null,
