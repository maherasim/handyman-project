...
class ServiceDetailResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'total_review'  => $this->serviceRatingPublic->count('id'),
            'total_rating'  => $this->serviceRatingPublic->count() > 0 ? (float) number_format(max($this->serviceRatingPublic->avg('rating'), 0), 2) : 0,
