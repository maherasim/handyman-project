                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <select name="country_id" id="country_id" class="select2js form-group category"
                                        ...
                                        <option value="{{ optional($postJob->country)->id }}" selected>
                                            {{ optional($postJob->country)->name }}</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <select name="city_id" id="city_id" class="select2js form-group category" required
                                        data-placeholder="{{ __('messages.select_name', ['select' => __('messages.city')]) }}"></select>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-2" id="price_div">
                                    ...
                                    <input type="number" name="price" id="price" class="form-control"
                                        min="1" step="any" placeholder="{{ __('messages.price') }}" required
                                        value="{{ old('price', $postJob->price) }}">
                                    <small class="help-block with-errors text-danger"></small>
                                </div>
                                ...
                                <div class="form-group col-md-2">
                                    <label for="total_hours_div">{{ __('messages.total_hours') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="number" name="total_hours" id="total_hours_div"
                                        class="form-control" min="1" step="any"
                                        placeholder="{{ __('messages.total_hours') }}" required
                                        value="{{ old('total_hours', $postJob->total_hours) }}">
                                    <small class="help-block with-errors text-danger"></small>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="title">{{ __('Requirment') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="requirnment" id="title" class="form-control"
