...
<ellipse cx="18.5" cy="18.375" rx="2.625" ry="1.5" stroke="currentColor" stroke-width="1.5"/>
    ...
    <defs>
        ...
        <?php $pendingCommissionCount = \App\Models\HandymanCommissionRequest::where('status', 'pending')->count(); ?>
        $menu->handyman
            ...
            ->prepend(
                '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2z" stroke="currentColor" stroke-width="1.5"/>
...
')
->nickname('custom_job')
->data('permission', 'Transaction Request');
...
$menu->add('<span>'.__('messages.sidebar_content_reports').'</span><span class="custom-tooltip"><span class="tooltip-text">'.__('messages.sidebar_content_reports_tooltip').'</span></span>', ['route' => 'admin.content-reports.index'])
->prepend(' <svg class="mr-2" width="15" height="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
