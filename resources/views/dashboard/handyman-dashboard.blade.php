                                ...
                                <div class="card-body p-3">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <p class="mb-0 booking-text">
                                                {{ __('messages.complete', ['name' => __('messages.booking')]) }}</p>
                                        </div>
                                        <div class="col-auto d-flex flex-column">
                                            <div
