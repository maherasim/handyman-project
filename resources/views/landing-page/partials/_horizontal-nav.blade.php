    ...
    <div class="container-fluid p-lg-0">
        ...
        <ul class="navbar-nav iq-nav-menu list-unstyled" id="header-menu">
            ...
            @php
                ...
                $installed_locales = array_map('basename', \File::directories(resource_path('lang')));
                if (is_array($language_option)) {
                    $language_option = array_values(array_unique(array_merge($language_option, ['en', 'de', 'fr'], $installed_locales)));
                }
