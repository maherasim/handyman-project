                     ...
                     @endif
                      ...
                      @if(auth()->check() && auth()->user()->user_type == 'user')
                        ...
                        <li class="nav-item ms-3">
                           <a href="{{ route('home') }}" class="btn btn-primary btn-sm {{ request()->routeIs('home') ? 'active' : '' }}" role="button">
                              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 12 15" fill="none" class="me-1">
                                 <g id="Profile">
                                    <g id="Group 6">
                                       <g id="Union">
                                          <path fill-rule="evenodd" clip-rule="evenodd"
