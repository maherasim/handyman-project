...
<head>
    ...
    <title>{{ $isRemaining ? __('messages.email_post_job_remaining_paid_title') : __('messages.email_post_job_advance_paid_title') }}</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        <div class="header">
            <h1>{{ $isRemaining ? __('messages.email_post_job_remaining_paid_title') : __('messages.email_post_job_advance_paid_title') }}</h1>
        </div>
        ...
        <div class="content">
            ...
            <p>{{ $isRemaining
                ? __('messages.email_post_job_remaining_paid_intro', ['title' => optional($postJob)->title ?? ''])
                : __('messages.email_post_job_advance_paid_intro', ['title' => optional($postJob)->title ?? '']) }}</p>
            ...
            <div class="info-box">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">{{ $isRemaining ? __('messages.email_payment_split_remaining') : __('messages.email_payment_split_advance') }}</span>
                </div>
                <div class="detail-row">
            ...
            <div class="action-box">
                ...
                <ul style="margin: 10px 0; padding-left: 20px; color: #155724;">
                    @if($isRemaining)
                        <li>{{ __('messages.email_post_job_step_completed') }}</li>
                    @else
                        <li>{{ __('messages.email_post_job_step_prepare') }}</li>
                        <li>{{ __('messages.email_post_job_step_contact') }}</li>
                    @endif
                </ul>
            </div>
