...
<body>
    <div class="email-container">
        <div class="header">
            <h1>Cash Payment – Verification Required</h1>
        </div>
        ...
        <div class="content">
            ...
            <div class="alert-box">
                ...
                <p>A customer has submitted a cash payment (bank transfer) for the following booking. Please check your bank account for the corresponding transfer.</p>
