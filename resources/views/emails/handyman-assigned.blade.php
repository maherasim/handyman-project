...
<head>
    ...
    <title>{{ __('messages.email_handyman_assigned_title') }}</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        <div class="header">
            <h1>{{ __('messages.email_handyman_assigned_title') }}</h1>
        </div>

        <div class="content">
            <h2>{{ __('messages.email_dear_name', ['name' => $handyman->display_name ?? $handyman->first_name ?? __('messages.email_there')]) }}</h2>

            <p>{{ __('messages.email_handyman_assigned_intro') }}</p>

            <div class="success-box">
                <div style="font-size: 48px; margin-bottom: 10px;">🛠️</div>
                <div class="message">{{ __('messages.email_handyman_assigned_confirmed') }}</div>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">
                        <span class="status-badge status-assigned">{{ __('messages.email_handyman_assigned_badge') }}</span>
                    </span>
                </div>
                <div class="detail-row">
            ...
            <div class="action-box">
                ...
                <ul style="margin: 10px 0; padding-left: 20px; color: #155724;">
                    <li>{{ __('messages.email_handyman_assigned_step_review') }}</li>
                    <li>{{ __('messages.email_handyman_assigned_step_prepare') }}</li>
                    <li>{{ __('messages.email_handyman_assigned_step_available') }}</li>
                    <li>{{ __('messages.email_handyman_assigned_step_contact') }}</li>
                </ul>
            </div>
