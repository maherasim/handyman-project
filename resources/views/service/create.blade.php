                    ...
                    <div class="card-body">
                       ...
                       <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                {{ Form::select(
                                    ...
                                    [
                                        ...
                                        'daily' => __('Daily'), // Added daily option
                            ...
                            <div class="form-group col-md-4">
                                {{ Form::label('name', __('Minimum Booking') . ' <span class="text-danger">*</span>', ['class' => 'form-control-label'], false) }}
                                {{ Form::text('minimum_booking', old('minimum_booking'), ['placeholder' => __('minimum booking'), 'class' => 'form-control', 'title' => 'Please enter minimum_booking']) }}
                                <small class="help-block with-errors text-danger"></small>
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                {{ Form::select(
                                    ...
                                    [
                                        'remote' => __('remote'),
                                        'hybrid' => __('hybrid'),
                                        'onsite' => __('onsite'), // Added visit type options
                                    ],
                                    old('visit_type'),
                                    ['id' => 'visit_type', 'class' => 'form-control select2js', 'required'],
                                ) }}
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                {{ Form::label('description', __('messages.description'), ['class' => 'form-control-label'], false) }}
                                {{ Form::textarea('description', old('description'), ['id' => 'description', 'class' => 'form-control']) }}
                            </div>
                            

                            <div class="form-group col-md-6">
                                {{ Form::label('name', __('Canellation Policy  Booking '), ['class' => 'form-control-label'], false) }}
                                {{ Form::textarea('cancellation_policy', old('cancellation_policy'), ['id' => 'cancellation_policy', 'class' => 'form-control']) }}
                            </div>
            ...
            (function($) {
                ...
                $(document).ready(function() {
                    ...
                    var service_address_id =
                        "{{ isset($servicedata->service_address_id) ? $servicedata->service_address_id : 0 }}";
