...
<head>
    ...
    <style>
        :root { --bs-primary-solid: #3333ff; --bs-primary-solid-hover: #2929e6; }
        .btn-primary, button.btn-primary, input[type="submit"].btn-primary, a.btn-primary {
            background: #3333ff !important; border: none !important; color: #fff !important;
        }
        .btn-primary:hover, button.btn-primary:hover, input[type="submit"].btn-primary:hover, a.btn-primary:hover {
            background: var(--bs-primary-solid-hover) !important; color: #fff !important;
        }
        ...
        .card-primary, .badge-primary, .alert-primary { background: #3333ff !important; color: #fff !important; }
        .nav-link.active, .nav-pills .nav-link.active { background: #3333ff !important; color: #fff !important; }
        .progress-bar.bg-primary { background: #3333ff !important; }
        .page-item.active .page-link { background: #3333ff !important; border-color: #3333ff !important; }
